class HollowCube extends HollowObject {
    /**
     * Constructor
    ...
    constructor(data = null, side_length = 1, frame_thickness = 0.1) {
        ...
        this.COORD_BASE = [
            [this.side_length / 2, - this.side_length / 2],
            [this.side_length / 2, this.side_length / 2],
            [- this.side_length / 2, this.side_length / 2],
            [- this.side_length / 2, - this.side_length / 2]        
        ]
    ...
    generate_connector() {
        ...
        for (var i = 0; i < 4; i++) {
            var point = []
            var curIdx = i
            var prevIdx = (((i - 1) % 4) + 4) % 4
            var xmul = (i == 0 || i == 1) ? 1 : -1;
            var zmul = (i == 0 || i == 3) ? -1 : 1; 
            ...
            for (var j = 0; j < 8; j++) {
                ...
                if (j % 4 == 2) {
                    modx = this.frame_thickness * xmul
                    modz = this.frame_thickness * zmul
                }
                if (j % 4 == 3) {
